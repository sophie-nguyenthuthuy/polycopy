# polycopy status — 2026-08-14 23:52 UTC
...
perfect100  fills= 20 (closed 18, open 2) invested=$2,000 fees=$0.00 realized=$-160.79 openMTM=$-1.24 total=$-162.02 (-8.1%) win 5/18

== backtest fills ==
s10         fills= 43 (closed 29, open 14) invested=$430 fees=$0.00 realized=$+7.11 openMTM=$+2.29 total=$+9.40 (+2.2%) win 24/29
s100        fills= 43 (closed 29, open 14) invested=$4,300 fees=$0.00 realized=$+71.08 openMTM=$+22.94 total=$+94.02 (+2.2%) win 24/29
perfect100  fills=397 (closed 369, open 28) invested=$39,700 fees=$0.00 realized=$-1,581.35 openMTM=$+68.40 total=$-1,512.95 (-3.8%) win 286/369
```
