# polycopy status — 2026-08-16 10:54 UTC
...
== backtest fills ==
s10         fills= 77 (closed 42, open 35) invested=$770 fees=$0.00 realized=$+10.83 openMTM=$-1.82 total=$+9.01 (+1.2%) win 34/42
s100        fills= 77 (closed 42, open 35) invested=$7,700 fees=$0.00 realized=$+108.26 openMTM=$-18.18 total=$+90.08 (+1.2%) win 34/42
perfect100  fills=488 (closed 432, open 56) invested=$48,800 fees=$0.00 realized=$-1,367.98 openMTM=$+35.33 total=$-1,332.65 (-2.7%) win 336/432
```
