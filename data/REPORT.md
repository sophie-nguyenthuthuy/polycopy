# polycopy status — 2026-08-16 14:30 UTC
...
s10         fills=  4 (closed 0, open 4) invested=$40 fees=$0.00 realized=$+0.00 openMTM=$-1.26 total=$-1.26 (-3.2%) win 0/0
s100        fills=  4 (closed 0, open 4) invested=$400 fees=$0.00 realized=$+0.00 openMTM=$-14.41 total=$-14.41 (-3.6%) win 0/0
perfect100  fills= 23 (closed 18, open 5) invested=$2,300 fees=$0.00 realized=$-160.79 openMTM=$+9.54 total=$-151.24 (-6.6%) win 5/18

== backtest fills ==
s10         fills= 77 (closed 42, open 35) invested=$770 fees=$0.00 realized=$+10.83 openMTM=$-2.15 total=$+8.68 (+1.1%) win 34/42
s100        fills= 77 (closed 42, open 35) invested=$7,700 fees=$0.00 realized=$+108.26 openMTM=$-21.49 total=$+86.77 (+1.1%) win 34/42
perfect100  fills=488 (closed 432, open 56) invested=$48,800 fees=$0.00 realized=$-1,367.98 openMTM=$+33.62 total=$-1,334.35 (-2.7%) win 336/432
```
