# polycopy status — 2026-08-11 13:57 UTC
...
s100        fills= 15 (closed 10, open 5) invested=$1,500 fees=$0.00 realized=$+17.83 openMTM=$+25.56 total=$+43.39 (+2.9%) win 8/10
perfect100  fills=126 (closed 119, open 7) invested=$12,600 fees=$0.00 realized=$-1,089.59 openMTM=$+24.34 total=$-1,065.25 (-8.5%) win 93/119
```
