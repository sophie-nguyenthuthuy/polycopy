# polycopy status — 2026-08-15 10:54 UTC
...
s10         fills=  3 (closed 0, open 3) invested=$30 fees=$0.00 realized=$+0.00 openMTM=$-0.99 total=$-0.99 (-3.3%) win 0/0
s100        fills=  3 (closed 0, open 3) invested=$300 fees=$0.00 realized=$+0.00 openMTM=$-10.83 total=$-10.83 (-3.6%) win 0/0
perfect100  fills= 22 (closed 18, open 4) invested=$2,200 fees=$0.00 realized=$-160.79 openMTM=$+1.99 total=$-158.80 (-7.2%) win 5/18

== backtest fills ==
s10         fills= 45 (closed 29, open 16) invested=$450 fees=$0.00 realized=$+7.11 openMTM=$+2.29 total=$+9.40 (+2.1%) win 24/29
s100        fills= 45 (closed 29, open 16) invested=$4,500 fees=$0.00 realized=$+71.08 openMTM=$+22.88 total=$+93.96 (+2.1%) win 24/29
perfect100  fills=399 (closed 370, open 29) invested=$39,900 fees=$0.00 realized=$-1,577.53 openMTM=$+75.49 total=$-1,502.04 (-3.8%) win 287/370
```
