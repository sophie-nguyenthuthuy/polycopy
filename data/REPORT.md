# polycopy status — 2026-08-16 17:49 UTC
...
perfect100  fills= 23 (closed 18, open 5) invested=$2,300 fees=$0.00 realized=$-160.79 openMTM=$-0.99 total=$-161.78 (-7.0%) win 5/18

== backtest fills ==
s10         fills= 77 (closed 42, open 35) invested=$770 fees=$0.00 realized=$+10.83 openMTM=$-3.46 total=$+7.37 (+1.0%) win 34/42
s100        fills= 77 (closed 42, open 35) invested=$7,700 fees=$0.00 realized=$+108.26 openMTM=$-34.59 total=$+73.67 (+1.0%) win 34/42
perfect100  fills=488 (closed 432, open 56) invested=$48,800 fees=$0.00 realized=$-1,367.98 openMTM=$+14.57 total=$-1,353.41 (-2.8%) win 336/432
```
