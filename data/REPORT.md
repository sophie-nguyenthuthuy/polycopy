# polycopy status — 2026-08-16 20:53 UTC
...
perfect100  fills= 23 (closed 18, open 5) invested=$2,300 fees=$0.00 realized=$-160.79 openMTM=$+0.60 total=$-160.19 (-7.0%) win 5/18

== backtest fills ==
s10         fills= 77 (closed 42, open 35) invested=$770 fees=$0.00 realized=$+10.83 openMTM=$-3.45 total=$+7.37 (+1.0%) win 34/42
s100        fills= 77 (closed 42, open 35) invested=$7,700 fees=$0.00 realized=$+108.26 openMTM=$-34.55 total=$+73.71 (+1.0%) win 34/42
perfect100  fills=488 (closed 432, open 56) invested=$48,800 fees=$0.00 realized=$-1,367.98 openMTM=$+16.39 total=$-1,351.59 (-2.8%) win 336/432
```
