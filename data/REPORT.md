# polycopy status — 2026-08-15 12:50 UTC
...
perfect100  fills= 22 (closed 18, open 4) invested=$2,200 fees=$0.00 realized=$-160.79 openMTM=$+5.57 total=$-155.21 (-7.1%) win 5/18

== backtest fills ==
s10         fills= 45 (closed 29, open 16) invested=$450 fees=$0.00 realized=$+7.11 openMTM=$+2.14 total=$+9.25 (+2.1%) win 24/29
s100        fills= 45 (closed 29, open 16) invested=$4,500 fees=$0.00 realized=$+71.08 openMTM=$+21.44 total=$+92.52 (+2.1%) win 24/29
perfect100  fills=399 (closed 370, open 29) invested=$39,900 fees=$0.00 realized=$-1,577.53 openMTM=$+73.15 total=$-1,504.39 (-3.8%) win 287/370
```
