# polycopy status — 2026-08-12 16:28 UTC
...
== backtest fills ==
s10         fills= 15 (closed 10, open 5) invested=$150 fees=$0.00 realized=$+1.78 openMTM=$+2.68 total=$+4.47 (+3.0%) win 8/10
s100        fills= 15 (closed 10, open 5) invested=$1,500 fees=$0.00 realized=$+17.83 openMTM=$+26.83 total=$+44.66 (+3.0%) win 8/10
perfect100  fills=182 (closed 165, open 17) invested=$18,200 fees=$0.00 realized=$-1,096.37 openMTM=$+37.31 total=$-1,059.06 (-5.8%) win 120/165
```
