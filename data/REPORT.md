# polycopy status — 2026-08-15 22:28 UTC
...
== backtest fills ==
s10         fills= 45 (closed 29, open 16) invested=$450 fees=$0.00 realized=$+7.11 openMTM=$+1.93 total=$+9.04 (+2.0%) win 24/29
s100        fills= 45 (closed 29, open 16) invested=$4,500 fees=$0.00 realized=$+71.08 openMTM=$+19.32 total=$+90.40 (+2.0%) win 24/29
perfect100  fills=399 (closed 370, open 29) invested=$39,900 fees=$0.00 realized=$-1,577.53 openMTM=$+79.46 total=$-1,498.07 (-3.8%) win 287/370
```
