# polycopy status — 2026-08-20 05:59 UTC
...
s10         fills= 11 (closed 2, open 9) invested=$110 fees=$0.00 realized=$+0.45 openMTM=$-0.41 total=$+0.03 (+0.0%) win 2/2
s100        fills= 11 (closed 2, open 9) invested=$1,100 fees=$0.00 realized=$+4.45 openMTM=$-16.65 total=$-12.19 (-1.1%) win 2/2
perfect100  fills= 34 (closed 24, open 10) invested=$3,400 fees=$0.00 realized=$-130.60 openMTM=$+14.10 total=$-116.50 (-3.4%) win 11/24

== backtest fills ==
s10         fills=107 (closed 59, open 48) invested=$1,070 fees=$0.00 realized=$+21.73 openMTM=$+10.88 total=$+32.61 (+3.0%) win 50/59
s100        fills=107 (closed 59, open 48) invested=$10,700 fees=$0.00 realized=$+217.29 openMTM=$+108.85 total=$+326.14 (+3.0%) win 50/59
perfect100  fills=814 (closed 729, open 85) invested=$81,400 fees=$0.00 realized=$-2,014.59 openMTM=$+185.59 total=$-1,828.99 (-2.2%) win 575/729
```
